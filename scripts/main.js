...
function turnScreenOn(secs) {
    if (isSafari()) {
        $(".shapeshiftos-content").css("-webkit-animation", "turn-on-safari " + secs + "s linear");
    }
    else {
        $(".shapeshiftos-content").css("animation", "turn-on " + secs + "s linear");
    }
}

function turnScreenOff(secs) {
    if (isSafari()) {
        $(".shapeshiftos-content").css("-webkit-animation", "turn-off-safari " + secs + "s linear forwards");
    }
    else {
        $(".shapeshiftos-content").css("animation", "turn-off " + secs + "s linear forwards");
    }
}
...
function initTerms() {
    $(".shapeshiftos-terms").on("click", function() {
        window.location.hash = "terms";
    });
    $(".shapeshiftos-privacy").on("click", function() {
...
function initHash() {
    $(window).hashchange(function() {
        ...
        switch (cleanHash) {
            case 'blank':
                changePage("./pages/landing.html", 3.4, 0.35, 400);
                break;
            case 'home':
                changePage("./pages/home.html", 3.4, 0.35, 400);
                break;
            case 'about':
                changePage("./pages/about.html", 3.4, 0.35, 400);
                break;
            case 'contact':
                changePage("https://t.me/ShapeShiftOSChannel", 3.4, 0.35, 400);
                break;
            case 'shop':
                changePage("https://sourceforge.net/projects/shapeshiftos/", 3.4, 0.35, 400);
                break;
            case 'checkout':
                changePage("./pages/checkout.html", 3.4, 0.35, 400);
                break;
            case 'videos':
                break;
            case 'pictures':
                changePage("https://github.com/ShapeShiftOS", 3.4, 0.35, 400);
                break;
            case 'privacy':
                changePage("./pages/privacy.html", 3.4, 0.35, 400);
                break;
            case 'terms':
                changePage("./pages/terms.html", 3.4, 0.35, 400);
                break;
            case 'shapeshiftosDVD':
                changePage("https://github.com/ShapeShiftOS", 3.4, 0.35, 400);
                break;
            case 'shapeshiftosDVD-vol-1':
                changePage("./pages/shapeshiftosDVD-vol-1.html", 3.4, 0.35, 400);
                break;
            case 'shapeshiftosDVD-vol-2':
                changePage("./pages/shapeshiftosDVD-vol-2.html", 3.4, 0.35, 400);
                break;
            case 'media':
                changePage("./pages/home.html", 0, 0, 0);
                break;
            default:
                changePage("./pages/error.html", 3.4, 0.35, 400);
                break;
        }
    });
...
function homeLoad() {
    $('.shop-button').click(function() {
        window.open("https://sourceforge.net/projects/shapeshiftos/", "_blank");
    });
    $('.github-button').click(function() {
        window.open("https://github.com/ShapeShiftOS", "_blank");
    });
    $('.about-button').click(function() {
        window.location.hash = "about";
    });
    $('#home-shapeshiftosDVD').click(function() {
        window.open("https://github.com/ShapeShiftOS", "_blank");
    });
    ...
    $('.contact-button').click(function() {
        window.open("https://t.me/ShapeShiftOSChannel", "_blank");
    });
...
function shapeshiftosDVDVolLoad() {
...
function loadPage(dir, time) {
    $("#shapeshiftos-content").load(dir, function() {
        $("#shapeshiftos-tube-border").removeClass("shapeshiftos-tube-border-mobile");

        switch (dir) {
            case "./pages/landing.html":
                $("#shapeshiftos-tube-border").addClass("shapeshiftos-tube-border-mobile");
                landingLoad();
                break;
            ...
            case "./pages/pictures.html":
                picturesLoad();
                break;
            case "./pages/shapeshiftosDVD.html":
                window.open("https://github.com/ShapeShiftOS", "_blank");
                break;
            case "./pages/shapeshiftosDVD-vol-1.html":
                shapeshiftosDVDVolLoad();
                break;
            case "./pages/shapeshiftosDVD-vol-2.html":
                shapeshiftosDVDVolLoad();
                break;
        ...
        $("#shapeshiftos-home").click(function() {
            window.location.hash = "home";
        });
        initModal();
        turnScreenOn(time);
...
function changePage(dir, time, ScreenOff, timeout) {
    turnScreenOff(ScreenOff);
    setTimeout(loadPage, timeout, dir, time);
}
...
var videos = {
    1: {
        ...
        title: "ShapeShiftOS 01",
        desc: "ShapeShiftOS 01 DESCRIPTION"
    },
    2: {
...
var shop = {
    shirts: {
        ...
        2: {
            name: "ShapeShiftOS OR NOTHING SHIRT",
...
function initShopify() {
    shopClient = ShopifyBuy.buildClient({
        ...
        domain: 'shapeshiftosshit.myshopify.com',
        appId: '6'
    });
...
function loadModel(name) {
    ...
    mtlLoader.setPath('./shapeshiftos-media/models/');
